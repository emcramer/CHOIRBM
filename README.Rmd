...
CHOIRBM is a collection of plotting utilities for the [Collaborative Health Outcomes Information Registry's](http://www.choir.stanford.edu) Body Map (CBM). The CBM is an instrument for assessing the distribution of a patient's pain, and has been validated in a paper published in [_Pain Reports_ (Scherrer et al 2021)](https://doi.org/10.1097/pr9.0000000000000880).

![The CHOIR Body Map](https://images.journals.lww.com/painrpts/Original.01938936-202102000-00006.F1.jpeg)
